...
- **Version:** 3.47.0 (pinned in `../versions.txt`, Renovate-tracked via npm `@tabler/icons`)
- **Source:** `icons/outline/*.svg` from <https://github.com/tabler/tabler-icons> at tag `v3.47.0`
