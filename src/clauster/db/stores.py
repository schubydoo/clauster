...
_INSTANCE_FIELDS = (
    ...
    "keeper_proc_start",
    # The drift-immune half of the keeper pair (#1402), exactly as ``bridge_start_ticks`` is
    # for the bridge. ``_present`` drops the NULL for a pre-#1402 row, which then compares on
    # the epoch alone until that keeper is next spawned, reattached or adopted.
    "keeper_start_ticks",
)
